---
title:  "How to Choose Colors for Your Map, Part I"
...
<!-- MOVE TO DOCUMENTATION ACCT IF APPROVED -->
<iframe width="100%" height="520" frameborder="0" src="https://team.cartodb.com/u/stephaniemongon/viz/8119e168-c14f-11e5-8b1b-0ea31932ec1d/embed_map" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>
...
## I need to pick a color scheme for my map. Where do I start?
...
<!-- FIND ANOTHER EXAMPLE besides election map so you can use colors that oppose exactly on wheel -->
Check out how complementary and analagous colors are used in [this map.]( ) Notice how easy it is to pick out one voting party from another, because they are using high-contrast yellow and purple. The red-violet/red/red-orange analagous colors stand out from each other enough to distinguish areas of different intensity, but at the same time they're showing that those voters are related by party. 
...
If it's hard to pick out one color against another, that's a hint their contrast is too low.
...
## I've picked some colors to start. How should I adjust them for legibility?
...
Saturation is color intensity. A pure color is fully saturated. As you desaturate a color it becomes more gray, if it's at 50% brightness. If it's at 100% brightness then a completely desaturated color is white. If it's at 0% brightness than a completely desaturated color is black.
<!-- saturation graphic -->
...
Changing the hue is also an option if your colors don't contrast enough. Use the color wheel as a guide for what other colors should be used with this new hue. If you like the hue you have but need to pump up the contrast, play with increasing the saturation or using a lighter or darker version of at least one color. 

We toned down the first image in this lesson by decreasing the red's saturation and it's brightness. We also decreased the brightness of the text, and changed it's hue slightly. Now it's not as annoying to read:

<!-- tone down ouch image -->
<!-- BUILD A SLIDER -->
...
This is what our red and green image looks like to people with color blindness:

<!-- adjusted red/green image -->

Good use of color contrast is important to make your maps legible for people with color blindness or limited vision. [Accessibility guidelines](https://www.w3.org/TR/WCAG20/) offer standards for contrast ratios, but an even easier way to make sure your map can be seen well is to use an online contrast checker. [Here's one](https://chrome.google.com/webstore/detail/nocoffee/jjeeggmbnhckmgdhmgdckeigabjfbddl?hl=en-US) that lets you look at your map while simulating different visual impairments, and [here's another](http://webaim.org/resources/contrastchecker/) that lets you enter pairs of hex values to check if their contrast ratio is high enough.
...
Look at the dots within the squares below. Do they look like different colors?

<!-- simultaneous contrast squares w/dots -->

Actually they are the same color, it's just that we perceive a color shift in them due to the colors they're seen against. 

<!-- dots side by side -->

One way to lessen this effect is to reduce the contrast between the foreground and background colors. We did this in the example below by reducing the background color's saturation, and increasing it's brightness.

<!-- simultaneous contrast squares w/dots reduced simultaneous contrast -->

### Contrast of Extension

Check out how these complementary colors contrast:

<!-- checkerboard of dots -->
...
## Creating complete color schemes for your map
