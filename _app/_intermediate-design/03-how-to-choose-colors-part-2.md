...
A quick CartoCSS trick for this is [**lighten**](https://carto.com/docs/carto-engine/cartocss/properties/#color) if you're starting with a light color (there's also **darken** for the opposite effect).
